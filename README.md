...
### 1. Tạo tài khoản
- **Bước 1**: Truy cập [trang chủ GitHub](https://github.com/) và chọn **Sign up**.
...
**Bước 1**: **Kiểm tra máy đã có SSH key chưa**
   - Ở màn hình desktop, chuột phải chọn **Git Bash Here** và chạy lệnh:
     ...
     ls -al ~/.ssh
     ```
   - Nếu có dòng `id_rsa`, tức là máy đã có SSH key.
     
   ![Kết quả kiểm tra SSH key](https://png.pngtree.com/thumb_back/fh260/background/20230511/pngtree-nature-background-sunset-wallpaer-with-beautiful-flower-farms-image_2592160.jpg)
